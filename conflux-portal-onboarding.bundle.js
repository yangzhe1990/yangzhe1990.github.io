var ConfluxPortalOnboarding = (function () {
    'use strict';
    ...
    const EXTENSION_DOWNLOAD_URL = {
        ...
        CHROME: 'https://github.com/Conflux-Chain/conflux-portal/releases',
        FIREFOX: 'https://github.com/Conflux-Chain/conflux-portal/releases',
        DEFAULT: 'https://github.com/Conflux-Chain/conflux-portal/releases',
    };
    ...
    class Onboarding {
        ...
        async _onMessage (event) {
            ...
            if (event.data.type === 'conflux-portal:reload') {
        ...
        /**
         * Starts onboarding by opening the ConfluxPortal download page and the Onboarding forwarder
         */
        startOnboarding () {
        ...
        static isConfluxPortalInstalled () {
            return Boolean(window.ethereum && window.ethereum.isConfluxPortal)
        }
